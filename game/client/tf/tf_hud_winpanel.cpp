...
// TF‑specific win reasons (not defined in shared headers)
enum {
        WINREASON_RD_REACTOR_CAPTURED = 9,
        WINREASON_RD_CORES_COLLECTED = 10,
        WINREASON_RD_REACTOR_RETURNED = 11,
        WINREASON_PD_POINTS = 12,
        WINREASON_SCORED = 13,
        WINREASON_STOPWATCH_WATCHING_ROUNDS = 14,
        WINREASON_STOPWATCH_WATCHING_FINAL_ROUND = 15,
        WINREASON_STOPWATCH_PLAYING_ROUNDS = 16,
};
