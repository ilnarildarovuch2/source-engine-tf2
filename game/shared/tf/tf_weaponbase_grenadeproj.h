...
public:
        ...
        virtual void                    Destroy( bool bBlinkOut = true, bool bBreak = false );
        ...
        virtual bool                    IsDestroyable( bool bOrbAttack = false ) { return ( !bOrbAttack ? ( gpGlobals->curtime > m_flDestroyableTime ) : true ); }
